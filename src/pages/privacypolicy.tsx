      ...
      <MainLayout pagetitle="Datenschutz&shy;erklärung">
        <section className="col-start-2 col-end-4">
          ...
          <p>
            ...
            &ldquo;überwiegendes Interesse&rdquo; und &ldquo;besonders
            schützenswerte Personendaten&rdquo; werden die in der DSGVO
            verwendeten Begriffe &ldquo;Verarbeitung“ von
            &ldquo;personenbezogenen Daten&rdquo; sowie &ldquo;berechtigtes
            Interesse&rdquo; und &ldquo;besondere Kategorien von Daten&rdquo;
          ...
          <h3 className="my-2 font-bold text-xl">Zwecke der Verarbeitung</h3>
          <ul>
          ...
          <p>
            ...
            Angemesenheitsbeschlüsse als Grundlagen vorrangig gelten.
          ...
          <ul className="m-elements">
            <li>
              ...
              &ldquo;Server-Logfiles&rdquo; protokolliert. Zu den Serverlogfiles
