  ...
  return (
    <>
      <MainLayout pagetitle="Datenschutz&shy;erklärung">
        ...
        <p>
          Tatjana Nabrotzky und Oksana Welk, Auf Stieneckers 52, 49549 Ladbergen
        </p>
        ...
        <p>
          ...
          Personendaten&rdquo; werden die in der DSGVO verwendeten Begriffe
          &ldquo;Verarbeitung“ von &ldquo;personenbezogenen Daten&rdquo; sowie
          &ldquo;berechtigtes Interesse&rdquo; und &ldquo;besondere Kategorien
          von Daten&rdquo; verwendet. Die gesetzliche Bedeutung der Begriffe
        ...
        <p>
          ...
          mit, wobei die Angemesenheitsbeschlüsse als Grundlagen vorrangig
        ...
        <ul className="m-elements">
          <li>
            ...
            an Inhalten. Meta-, Kommunikations- und Verfahrensdaten (z. B.
